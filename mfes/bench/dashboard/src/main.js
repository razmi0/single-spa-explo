...
function generateSummary(data) {
    ...
    summaryEl.innerHTML = `
    <p>🏆 <span class="dashboard__summary-highlight">${
        fastest.name
    }</span> is the fastest bundler with a build time of <span class="dashboard__summary-highlight">${formatTime(
        fastest.time
    )}</span></p>
    <p>📈 ${fastest.name} is <span class="dashboard__summary-highlight">${speedup.toFixed(0)}% faster</span> than ${
        slowest.name
    }</p>
    
    <div class="dashboard__comparison">
      <div class="dashboard__comparison-row">
...
// Initialize dashboard - exported for single-spa lifecycle
